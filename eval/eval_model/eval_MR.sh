...
EXPLORATION_N_VALUES=(1 2 3 5 7)
...
do
  ...
  OUTPUT_DIR="eval/outputs/HMEV_${MODEL_NAME}_N${EXPLORATION_N}_E${MAX_EXPLORATION_STEPS}_APM${ACCELERATION_PARALLEL_METHOD}_PWT${POSITIONAL_WEIGHTS_TYPE}_imw${INITIAL_MIN_WEIGHT}_V5dense+_${N_LIMIT:+limit_$N_LIMIT}/${TASKS}/"
